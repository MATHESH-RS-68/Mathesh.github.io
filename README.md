...
<head>
    ...
    <style>
        ...
        body {
            ...
            cursor: url('image/rocket.jpg') 16 16, pointer;
        }
        .futuristic-glow {
            text-shadow: 0 0 8px #ff9100, 0 0 16px #ff9100, 0 0 32px #ff9100;
            letter-spacing: 2px;
        }
        .futuristic-btn, .music-toggle-btn {
            background: #111;
            color: #ff9100;
            ...
            font-size: 1.1em;
            font-family: 'Orbitron', 'Segoe UI', Arial, sans-serif;
            box-shadow: 0 0 12px #ff9100, 0 0 24px #ff9100 inset;
            cursor: pointer;
            transition: background 0.3s, color 0.3s, box-shadow 0.3s;
        }
        .futuristic-btn:hover, .music-toggle-btn:hover {
            background: #ff9100;
            color: #111;
            box-shadow: 0 0 24px #ff9100, 0 0 48px #ff9100 inset;
        }
        .futuristic-btn {
            position: fixed;
            top: 10px;
        ...
        hr {
            border: 0;
            height: 2px;
            background: linear-gradient(90deg, #ff9100 0%, #232323 100%);
            margin: 30px 0;
            box-shadow: 0 0 16px #ff9100;
        }
        a {
            color: #ff9100;
...
<body id="mainBody">
    ...
    <script>
        ...
        // Rocket trail effect for cursor
